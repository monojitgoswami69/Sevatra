...
import { register as apiRegister, verifyEmail as apiVerifyEmail, resendOtp as apiResendOtp } from '../../services/authService';
...
const Register: React.FC = () => {
  ...
  // Registration step: 'register' → fill form, 'verify' → enter OTP
    ...
    if (validateForm()) {
      ...
      try {
        await apiRegister({
          ...
          icu_beds: formData.icuBeds ? parseInt(formData.icuBeds) : 0,
          hdu_beds: formData.hduBeds ? parseInt(formData.hduBeds) : 0,
          general_beds: formData.generalBeds ? parseInt(formData.generalBeds) : 0,
        });
  ...
  const handleVerify = async () => {
    ...
    setApiError('');
    try {
      await apiVerifyEmail(formData.email, code);
          ...
          <div className="mb-10 flex flex-col gap-6">
            ...
            <div>
              <h1 className={`tracking-tight text-3xl font-bold leading-tight mb-2 ${
                ...
                {step === 'register' ? 'Register Hospital' : 'Verify Email'}
              </h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="pt-6 pb-6">
              <button 
                ...
                className={`flex w-full cursor-pointer items-center justify-center overflow-hidden h-14 px-5 active:scale-[0.98] transition-all duration-300 text-lg font-bold leading-normal tracking-wide relative group disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 ${
                  isDarkMode 
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-center pt-4">
              <div className={`flex h-20 w-20 items-center justify-center rounded-full ${
                isDarkMode
                  ? 'bg-primary/10 border border-primary/20 text-primary shadow-[0_0_40px_rgba(19,236,19,0.3)]'
                  : 'bg-emerald-50 border border-emerald-200 text-emerald-600 shadow-[0_0_30px_rgba(16,185,129,0.2)]'
              }`}>
            ...
            <div className="flex justify-center gap-3" onPaste={handleOtpPaste}>
              {otpDigits.map((digit, idx) => (
                <input
                  ...
                  className={`w-13 h-14 text-center text-2xl font-bold rounded-xl border-2 transition-all focus:outline-none ${
                    isDarkMode
                      ? 'bg-card border-border text-card-foreground focus:border-primary focus:shadow-[0_0_20px_rgba(19,236,19,0.25)]'
                      : 'bg-slate-50 border-slate-200 text-slate-900 focus:border-emerald-500 focus:shadow-[0_0_15px_rgba(16,185,129,0.15)]'
                  }`}
                />
              ))}
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className={`flex w-full cursor-pointer items-center justify-center h-14 px-5 active:scale-[0.98] transition-all duration-300 text-lg font-bold tracking-wide relative group disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 ${
                  isDarkMode
                    ? 'rounded-xl bg-primary hover:bg-[#3bf03b] text-green-950 shadow-[0_0_30px_rgba(19,236,19,0.4)] hover:shadow-[0_0_50px_rgba(19,236,19,0.7)] hover:scale-105'
                    : 'rounded-full bg-primary hover:bg-[#3bf03b] text-green-950 shadow-[0_0_30px_rgba(19,236,19,0.5)] hover:shadow-[0_0_50px_rgba(19,236,19,0.8)] hover:scale-105'
                }`}
              >
                <span className="truncate relative z-10">
            ...
            <div className="text-center">
              <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-slate-500'}`}>
                ...
                {resendCooldown > 0 ? (
                  <span className={`font-medium ${isDarkMode ? 'text-gray-500' : 'text-slate-400'}`}>
                  ...
                  <button
                    ...
                    className={`font-bold hover:underline ${isDarkMode ? 'text-primary' : 'text-green-600'}`}
                  >
                    Resend Code
                  </button>
                )}
            ...
            <div className="text-center">
              <button
                type="button"
                onClick={() => { setStep('register'); setApiError(''); setSuccessMessage(''); }}
                className={`text-sm font-medium hover:underline ${isDarkMode ? 'text-gray-400 hover:text-gray-300' : 'text-slate-500 hover:text-slate-700'}`}
              >
