  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted px-4">
      <div className="text-center max-w-md">
        {/* Heartbeat Icon */}
        <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-2xl bg-primary/10 border border-[#13ec13]/20 shadow-[0_0_40px_rgba(19,236,19,0.15)]">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="rounded-xl bg-primary px-6 py-3 text-sm font-bold text-green-950 hover:bg-[#3bf03b] shadow-[0_0_20px_rgba(19,236,19,0.4)] hover:shadow-[0_0_30px_rgba(19,236,19,0.6)] transition-all"
          >
            Dashboard
          </button>
        </div>
