...
from app.models.life import AdmissionCreate, VitalsUpdate, ClinicalUpdate, DischargeRequest
from app.services import life_admission_service as svc
...
async def discharge_patient(
    ...
    db = get_db()
    notes = payload.discharge_notes if payload else None
