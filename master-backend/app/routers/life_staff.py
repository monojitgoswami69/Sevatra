...
from app.models.life import StaffCreate, StaffUpdate
from app.services import life_staff_service as svc
...
async def toggle_duty(
    ...
    on_duty = body.get("on_duty", not existing.get("on_duty", False))
